...
class JoinGroupe extends StatefulWidget {
  const JoinGroupe({Key? key}) : super(key: key);

  @override
  State<JoinGroupe> createState() => _AddPageState();
}

class _AddPageState extends State<JoinGroupe> with SingleTickerProviderStateMixin {
